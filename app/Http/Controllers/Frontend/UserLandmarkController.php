...
class UserLandmarkController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.userLandmarks.index', compact('userLandmarks'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.userLandmarks.create', compact('landmarks', 'users'));
    }
    ...
    public function store(StoreUserLandmarkRequest $request)
    {
        ...
        return redirect()->route('frontend.user-landmarks.index');
    }
    ...
    public function edit(UserLandmark $userLandmark)
    {
        ...
        return view('frontend.userLandmarks.edit', compact('landmarks', 'userLandmark', 'users'));
    }
    ...
    public function show(UserLandmark $userLandmark)
    {
        ...
        return view('frontend.userLandmarks.show', compact('userLandmark'));
    }
