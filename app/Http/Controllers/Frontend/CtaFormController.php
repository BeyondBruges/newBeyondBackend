...
class CtaFormController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.ctaForms.index', compact('ctaForms'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.ctaForms.create', compact('languages'));
    }
    ...
    public function store(StoreCtaFormRequest $request)
    {
        ...
        return redirect()->route('frontend.cta-forms.index');
    }
    ...
    public function edit(CtaForm $ctaForm)
    {
        ...
        return view('frontend.ctaForms.edit', compact('ctaForm', 'languages'));
    }
    ...
    public function show(CtaForm $ctaForm)
    {
        ...
        return view('frontend.ctaForms.show', compact('ctaForm'));
    }
