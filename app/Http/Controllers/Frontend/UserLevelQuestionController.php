...
class UserLevelQuestionController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.userLevelQuestions.index', compact('userLevelQuestions'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.userLevelQuestions.create', compact('questions', 'users'));
    }
    ...
    public function store(StoreUserLevelQuestionRequest $request)
    {
        ...
        return redirect()->route('frontend.user-level-questions.index');
    }
    ...
    public function edit(UserLevelQuestion $userLevelQuestion)
    {
        ...
        return view('frontend.userLevelQuestions.edit', compact('questions', 'userLevelQuestion', 'users'));
    }
    ...
    public function show(UserLevelQuestion $userLevelQuestion)
    {
        ...
        return view('frontend.userLevelQuestions.show', compact('userLevelQuestion'));
    }
