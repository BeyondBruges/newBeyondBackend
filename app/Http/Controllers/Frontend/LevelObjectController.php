...
class LevelObjectController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.levelObjects.index', compact('levelObjects', 'levels'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.levelObjects.create', compact('levels'));
    }
    ...
    public function store(StoreLevelObjectRequest $request)
    {
        ...
        return redirect()->route('frontend.level-objects.index');
    }
    ...
    public function edit(LevelObject $levelObject)
    {
        ...
        return view('frontend.levelObjects.edit', compact('levelObject', 'levels'));
    }
    ...
    public function show(LevelObject $levelObject)
    {
        ...
        return view('frontend.levelObjects.show', compact('levelObject'));
    }
