...
class UserLevelObjectController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.userLevelObjects.index', compact('userLevelObjects'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.userLevelObjects.create', compact('level_objects', 'users'));
    }
    ...
    public function store(StoreUserLevelObjectRequest $request)
    {
        ...
        return redirect()->route('frontend.user-level-objects.index');
    }
    ...
    public function edit(UserLevelObject $userLevelObject)
    {
        ...
        return view('frontend.userLevelObjects.edit', compact('level_objects', 'userLevelObject', 'users'));
    }
    ...
    public function show(UserLevelObject $userLevelObject)
    {
        ...
        return view('frontend.userLevelObjects.show', compact('userLevelObject'));
    }
