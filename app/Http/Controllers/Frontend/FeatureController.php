...
class FeatureController extends Controller
{
    public function index()
    {
        ...
        $features = Feature::with(['language'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.features.create', compact('languages'));
    }
    ...
    public function store(StoreFeatureRequest $request)
    {
        ...
        return redirect()->route('frontend.features.index');
    }
    ...
    public function edit(Feature $feature)
    {
        ...
        $feature->load('language');

        return view('frontend.features.edit', compact('feature', 'languages'));
    }
