...
class BlandmarkContentController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.blandmarkContents.index', compact('b_land_marks', 'blandmarkContents'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.blandmarkContents.create', compact('landmarks'));
    }
    ...
    public function store(StoreBlandmarkContentRequest $request)
    {
        ...
        return redirect()->route('frontend.blandmark-contents.index');
    }
    ...
    public function edit(BlandmarkContent $blandmarkContent)
    {
        ...
        return view('frontend.blandmarkContents.edit', compact('blandmarkContent', 'landmarks'));
    }
    ...
    public function show(BlandmarkContent $blandmarkContent)
    {
        ...
        return view('frontend.blandmarkContents.show', compact('blandmarkContent'));
    }
