...
class AppPopupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.appPopups.index', compact('appPopups'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.appPopups.create', compact('languages'));
    }
    ...
    public function store(StoreAppPopupRequest $request)
    {
        ...
        return redirect()->route('frontend.app-popups.index');
    }
    ...
    public function edit(AppPopup $appPopup)
    {
        ...
        return view('frontend.appPopups.edit', compact('appPopup', 'languages'));
    }
    ...
    public function show(AppPopup $appPopup)
    {
        ...
        return view('frontend.appPopups.show', compact('appPopup'));
    }
