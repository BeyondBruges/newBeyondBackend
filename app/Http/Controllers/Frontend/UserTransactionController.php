...
class UserTransactionController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.userTransactions.index', compact('userTransactions'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.userTransactions.create', compact('transactions', 'users'));
    }
    ...
    public function store(StoreUserTransactionRequest $request)
    {
        ...
        return redirect()->route('frontend.user-transactions.index');
    }
    ...
    public function edit(UserTransaction $userTransaction)
    {
        ...
        return view('frontend.userTransactions.edit', compact('transactions', 'userTransaction', 'users'));
    }
    ...
    public function show(UserTransaction $userTransaction)
    {
        ...
        return view('frontend.userTransactions.show', compact('userTransaction'));
    }
