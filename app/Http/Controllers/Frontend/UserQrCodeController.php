...
class UserQrCodeController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.userQrCodes.index', compact('userQrCodes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.userQrCodes.create', compact('qrs', 'users'));
    }
    ...
    public function store(StoreUserQrCodeRequest $request)
    {
        ...
        return redirect()->route('frontend.user-qr-codes.index');
    }
    ...
    public function edit(UserQrCode $userQrCode)
    {
        ...
        return view('frontend.userQrCodes.edit', compact('qrs', 'userQrCode', 'users'));
    }
    ...
    public function show(UserQrCode $userQrCode)
    {
        ...
        return view('frontend.userQrCodes.show', compact('userQrCode'));
    }
