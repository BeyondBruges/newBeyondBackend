...
class BLandMarkController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.bLandMarks.index', compact('bLandMarks'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.bLandMarks.create');
    }
    ...
    public function store(StoreBLandMarkRequest $request)
    {
        ...
        return redirect()->route('frontend.b-land-marks.index');
    }
    ...
    public function edit(BLandMark $bLandMark)
    {
        ...
        return view('frontend.bLandMarks.edit', compact('bLandMark'));
    }
    ...
    public function show(BLandMark $bLandMark)
    {
        ...
        return view('frontend.bLandMarks.show', compact('bLandMark'));
    }
