...
class UserLevelController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.userLevels.index', compact('userLevels'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.userLevels.create', compact('levels', 'users'));
    }
    ...
    public function store(StoreUserLevelRequest $request)
    {
        ...
        return redirect()->route('frontend.user-levels.index');
    }
    ...
    public function edit(UserLevel $userLevel)
    {
        ...
        return view('frontend.userLevels.edit', compact('levels', 'userLevel', 'users'));
    }
    ...
    public function show(UserLevel $userLevel)
    {
        ...
        return view('frontend.userLevels.show', compact('userLevel'));
    }
