...
class SliderController extends Controller
{
    ...
    public function index()
    {
        ...
        $sliders = Slider::with(['language', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.sliders.create', compact('languages'));
    }
    ...
    public function edit(Slider $slider)
    {
        ...
        $slider->load('language');

        return view('frontend.sliders.edit', compact('languages', 'slider'));
    }
