...
class ProductDescriptionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.productDescriptions.index', compact('productDescriptions'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.productDescriptions.create', compact('products'));
    }
    ...
    public function store(StoreProductDescriptionRequest $request)
    {
        ...
        return redirect()->route('frontend.product-descriptions.index');
    }
    ...
    public function edit(ProductDescription $productDescription)
    {
        ...
        return view('frontend.productDescriptions.edit', compact('productDescription', 'products'));
    }
    ...
    public function show(ProductDescription $productDescription)
    {
        ...
        return view('frontend.productDescriptions.show', compact('productDescription'));
    }
