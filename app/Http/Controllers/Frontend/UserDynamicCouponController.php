...
class UserDynamicCouponController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.userDynamicCoupons.index', compact('userDynamicCoupons'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.userDynamicCoupons.create', compact('dynamic_coupons', 'users'));
    }
    ...
    public function store(StoreUserDynamicCouponRequest $request)
    {
        ...
        return redirect()->route('frontend.user-dynamic-coupons.index');
    }
    ...
    public function edit(UserDynamicCoupon $userDynamicCoupon)
    {
        ...
        return view('frontend.userDynamicCoupons.edit', compact('dynamic_coupons', 'userDynamicCoupon', 'users'));
    }
    ...
    public function show(UserDynamicCoupon $userDynamicCoupon)
    {
        ...
        return view('frontend.userDynamicCoupons.show', compact('userDynamicCoupon'));
    }
