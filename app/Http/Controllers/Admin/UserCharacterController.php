...
class UserCharacterController extends Controller
{
    public function index()
    {
        ...
        return view('admin.userCharacters.index', compact('userCharacters'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.userCharacters.create', compact('characters', 'users'));
    }
    ...
    public function store(StoreUserCharacterRequest $request)
    {
        ...
        return redirect()->route('admin.user-characters.index');
    }
    ...
    public function edit(UserCharacter $userCharacter)
    {
        ...
        return view('admin.userCharacters.edit', compact('characters', 'userCharacter', 'users'));
    }
    ...
    public function show(UserCharacter $userCharacter)
    {
        ...
        return view('admin.userCharacters.show', compact('userCharacter'));
    }
