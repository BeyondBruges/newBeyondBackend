...
class AnalyticTypeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.analyticTypes.index', compact('analyticTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.analyticTypes.create');
    }
    ...
    public function store(StoreAnalyticTypeRequest $request)
    {
        ...
        return redirect()->route('admin.analytic-types.index');
    }
    ...
    public function edit(AnalyticType $analyticType)
    {
        ...
        return view('admin.analyticTypes.edit', compact('analyticType'));
    }
    ...
    public function show(AnalyticType $analyticType)
    {
        ...
        return view('admin.analyticTypes.show', compact('analyticType'));
    }
