...
class UserCouponController extends Controller
{
    public function index()
    {
        ...
        return view('admin.userCoupons.index', compact('userCoupons'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.userCoupons.create', compact('coupons', 'users'));
    }
    ...
    public function store(StoreUserCouponRequest $request)
    {
        ...
        return redirect()->route('admin.user-coupons.index');
    }
    ...
    public function edit(UserCoupon $userCoupon)
    {
        ...
        return view('admin.userCoupons.edit', compact('coupons', 'userCoupon', 'users'));
    }
    ...
    public function show(UserCoupon $userCoupon)
    {
        ...
        return view('admin.userCoupons.show', compact('userCoupon'));
    }
