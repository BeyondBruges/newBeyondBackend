...
class PartnerDescriptionController extends Controller
{
    public function index()
    {
        ...
        return view('admin.partnerDescriptions.index', compact('partnerDescriptions'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.partnerDescriptions.create', compact('languages', 'partners'));
    }
    ...
    public function store(StorePartnerDescriptionRequest $request)
    {
        ...
        return redirect()->route('admin.partner-descriptions.index');
    }
    ...
    public function edit(PartnerDescription $partnerDescription)
    {
        ...
        return view('admin.partnerDescriptions.edit', compact('languages', 'partnerDescription', 'partners'));
    }
    ...
    public function show(PartnerDescription $partnerDescription)
    {
        ...
        return view('admin.partnerDescriptions.show', compact('partnerDescription'));
    }
