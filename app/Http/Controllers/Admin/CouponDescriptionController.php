...
class CouponDescriptionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.couponDescriptions.index', compact('couponDescriptions'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.couponDescriptions.create', compact('coupons', 'languages'));
    }
    ...
    public function store(StoreCouponDescriptionRequest $request)
    {
        ...
        return redirect()->route('admin.coupon-descriptions.index');
    }
    ...
    public function edit(CouponDescription $couponDescription)
    {
        ...
        return view('admin.couponDescriptions.edit', compact('couponDescription', 'coupons', 'languages'));
    }
    ...
    public function show(CouponDescription $couponDescription)
    {
        ...
        return view('admin.couponDescriptions.show', compact('couponDescription'));
    }
