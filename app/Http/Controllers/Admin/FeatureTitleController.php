...
class FeatureTitleController extends Controller
{
    public function index()
    {
        ...
        return view('admin.featureTitles.index', compact('featureTitles'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.featureTitles.create', compact('languages'));
    }
    ...
    public function store(StoreFeatureTitleRequest $request)
    {
        ...
        return redirect()->route('admin.feature-titles.index');
    }
    ...
    public function edit(FeatureTitle $featureTitle)
    {
        ...
        return view('admin.featureTitles.edit', compact('featureTitle', 'languages'));
    }
    ...
    public function show(FeatureTitle $featureTitle)
    {
        ...
        return view('admin.featureTitles.show', compact('featureTitle'));
    }
