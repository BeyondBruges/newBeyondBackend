				...
				<div class="col-md-6">
					...
					<div class="input-group mb-3">
                        <div class="input-group mb-3">
                            ...
                            <label class="input-group-text" for="email_image_top">Email Image Top</label>
                            <input type="file" class="form-control" id="email_image_top" name="email_image_top">
                        </div>					</div>
					<div class="col-12">
					...
					<div class="input-group mb-3">
                        <div class="input-group mb-3">
                            ...
                            <label class="input-group-text" for="email_image_middle">Email Image Middle</label>
                            <input type="file" class="form-control" id="email_image_middle" name="email_image_middle">
                        </div>
                    </div>
					<br>
					<div class="col-12">
