...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.productDescription.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-descriptions.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('language') ? 'is-invalid' : '' }}" type="number" name="language" id="language" value="{{ old('language', '') }}" step="1">
