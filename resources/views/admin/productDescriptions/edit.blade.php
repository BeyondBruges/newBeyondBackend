...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-descriptions.update", [$productDescription->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $productDescription->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('language') ? 'is-invalid' : '' }}" type="number" name="language" id="language" value="{{ old('language', $productDescription->language) }}" step="1">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.product-descriptions.storeCKEditorImages') }}', true);
