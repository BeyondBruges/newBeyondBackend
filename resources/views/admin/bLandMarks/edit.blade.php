    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.b-land-marks.update", [$bLandMark->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lat') ? 'is-invalid' : '' }}" type="number" name="lat" id="lat" value="{{ old('lat', $bLandMark->lat) }}" step="0.01" required>
                @if($errors->has('lat'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lng') ? 'is-invalid' : '' }}" type="number" name="lng" id="lng" value="{{ old('lng', $bLandMark->lng) }}" step="0.01" required>
                @if($errors->has('lng'))
