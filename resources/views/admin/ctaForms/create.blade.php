...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.ctaForm.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.cta-forms.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('inputfield_text') ? 'is-invalid' : '' }}" type="text" name="inputfield_text" id="inputfield_text" value="{{ old('inputfield_text', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('legends_title') ? 'is-invalid' : '' }}" type="text" name="legends_title" id="legends_title" value="{{ old('legends_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('legends_subtitle') ? 'is-invalid' : '' }}" type="text" name="legends_subtitle" id="legends_subtitle" value="{{ old('legends_subtitle', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('legends_link') ? 'is-invalid' : '' }}" type="text" name="legends_link" id="legends_link" value="{{ old('legends_link', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('legends_button_text') ? 'is-invalid' : '' }}" type="text" name="legends_button_text" id="legends_button_text" value="{{ old('legends_button_text', '') }}">
