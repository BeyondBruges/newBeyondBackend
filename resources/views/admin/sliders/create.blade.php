    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sliders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('button_2_text') ? 'is-invalid' : '' }}" type="text" name="button_2_text" id="button_2_text" value="{{ old('button_2_text', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('button_2_url') ? 'is-invalid' : '' }}" type="text" name="button_2_url" id="button_2_url" value="{{ old('button_2_url', '') }}">
