...
@can('analytic_type_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.analytic-types.create') }}">
                        ...
                        <tr data-entry-id="{{ $analyticType->id }}">
                            ...
                            <td>
                                @can('analytic_type_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.analytic-types.show', $analyticType->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('analytic_type_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.analytic-types.edit', $analyticType->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
