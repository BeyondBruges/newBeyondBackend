...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-BlandmarkContent">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                ...
                                @foreach($b_land_marks as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-BlandmarkContent:not(.ajaxTable)').DataTable({ buttons: dtButtons })
