...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.push-notifications.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('en_content') ? 'is-invalid' : '' }}" type="text" name="en_content" id="en_content" value="{{ old('en_content', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('es_content') ? 'is-invalid' : '' }}" type="text" name="es_content" id="es_content" value="{{ old('es_content', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nl_content') ? 'is-invalid' : '' }}" type="text" name="nl_content" id="nl_content" value="{{ old('nl_content', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fr_content') ? 'is-invalid' : '' }}" type="text" name="fr_content" id="fr_content" value="{{ old('fr_content', '') }}" required>
