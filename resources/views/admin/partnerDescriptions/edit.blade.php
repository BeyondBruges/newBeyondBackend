    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.partner-descriptions.update", [$partnerDescription->id]) }}" enctype="multipart/form-data">
         ...
         <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $partnerDescription->description) !!}</textarea>
