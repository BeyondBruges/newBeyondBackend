...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contact-texts.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="contact_title">{{ trans('cruds.contactText.fields.contact_title') }}</label>
                <input class="form-control {{ $errors->has('contact_title') ? 'is-invalid' : '' }}" type="text" name="contact_title" id="contact_title" value="{{ old('contact_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_subtitle') ? 'is-invalid' : '' }}" type="text" name="contact_subtitle" id="contact_subtitle" value="{{ old('contact_subtitle', '') }}">
