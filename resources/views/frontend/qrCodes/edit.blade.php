    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.qr-codes.update", [$qrCode->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="transaction_total">{{ trans('cruds.qrCode.fields.transaction_total') }}</label>
                            <input class="form-control" type="number" name="transaction_total" id="transaction_total" value="{{ old('transaction_total', $qrCode->transaction_total) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="issued_bryghia" id="issued_bryghia" value="{{ old('issued_bryghia', $qrCode->issued_bryghia) }}" step="1" required>
