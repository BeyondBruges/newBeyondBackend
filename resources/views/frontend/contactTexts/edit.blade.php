    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.contact-texts.update", [$contactText->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="contact_title">{{ trans('cruds.contactText.fields.contact_title') }}</label>
                            <input class="form-control" type="text" name="contact_title" id="contact_title" value="{{ old('contact_title', $contactText->contact_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_subtitle" id="contact_subtitle" value="{{ old('contact_subtitle', $contactText->contact_subtitle) }}">
