                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.partners.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="lat" id="lat" value="{{ old('lat', '') }}" step="0.01">
                            @if($errors->has('lat'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('lat') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="lng" id="lng" value="{{ old('lng', '') }}" step="0.01">
                            @if($errors->has('lng'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('lng') }}
                                </div>
