                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.questions.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="option_b" id="option_b" value="{{ old('option_b', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="option_c" id="option_c" value="{{ old('option_c', '') }}">
