    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.cta-forms.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="inputfield_text" id="inputfield_text" value="{{ old('inputfield_text', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="legends_title" id="legends_title" value="{{ old('legends_title', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="legends_subtitle" id="legends_subtitle" value="{{ old('legends_subtitle', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="legends_link" id="legends_link" value="{{ old('legends_link', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="legends_button_text" id="legends_button_text" value="{{ old('legends_button_text', '') }}">
