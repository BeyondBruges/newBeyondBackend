                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sliders.update", [$slider->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hero_title" id="hero_title" value="{{ old('hero_title', $slider->hero_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hero_subtitle" id="hero_subtitle" value="{{ old('hero_subtitle', $slider->hero_subtitle) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="button_text" id="button_text" value="{{ old('button_text', $slider->button_text) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="button_url" id="button_url" value="{{ old('button_url', $slider->button_url) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="button_2_text" id="button_2_text" value="{{ old('button_2_text', $slider->button_2_text) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="button_2_url" id="button_2_url" value="{{ old('button_2_url', $slider->button_2_url) }}">
