                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.companies.update", [$company->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="google_analyitics" id="google_analyitics" value="{{ old('google_analyitics', $company->google_analyitics) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sendinblue_user" id="sendinblue_user" value="{{ old('sendinblue_user', $company->sendinblue_user) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sendinblue_password" id="sendinblue_password" value="{{ old('sendinblue_password', $company->sendinblue_password) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="onesignal_appid" id="onesignal_appid" value="{{ old('onesignal_appid', $company->onesignal_appid) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="onesignal_apikey" id="onesignal_apikey" value="{{ old('onesignal_apikey', $company->onesignal_apikey) }}">
